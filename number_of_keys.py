...
def new_key_names(private_key_name, public_key_name, directory, path_pattern='_%s', ext='pem'):
    ...
    path_pattern_2 = os.path.join(directory, private_key_name + path_pattern +'.' + ext)
...
print(new_key_names('private_key', 'public_key', '/home/zeefu/Documents/Volt/tshepo_molane/development', ext = '.pem'))
